...
#             # Audio file path is assumed to be the same name as the video_config file but in the source_audio_files directory
#             audio_file_path = os.path.join(source_audio_directory, f'{file_name.split(".")[0]}.mp3')
